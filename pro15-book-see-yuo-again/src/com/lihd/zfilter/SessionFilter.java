...
//        urlPatterns = "*.do",
//        initParams = {
//                @WebInitParam(name = "whiteList",value = "/pro15/render.do?page=user/login," +
//                        "/pro15/render.do?page=user/login," +
//                        "/pro15/render.do?page=user/register," +
//                        "/pro15/user.do?null," +
//                        "/pro15/user.do?operate=register," +
//                        "/pro15/render?page=index," +
//                        "/pro15/render.do?page=user/regist," +
//                        ""),
