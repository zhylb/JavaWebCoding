...
//        req.setCharacterEncoding("UTF-8"); 使用Filter实现
        //通过反射构建对象
        ...
        try {
            ...
            for (Method method : methods) {
                if(operate.equals(method.getName())){
                    ...
                    }else if(invoke.startsWith("json:")){
                        invoke = invoke.substring("json:".length());
            ...
            e.printStackTrace();
            throw new DispatchServletException("中央处理器出现错误");
        }
